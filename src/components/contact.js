            ...
            <div className="contact-body">
                <Row className="contact-grid">
                    <Col col={6}>
                        ...
                        />
                        <p style={{ width: '75%', margin: 'auto', paddingTop: '1em'}}>Hi, I'm Kita! I am a Full-Stack MERN Web and Mobile Developer. Lorem ipsum dolor sit amet consectetur adipisicing eListGroupItemt. Commodi sit odio hic iusto, numquam accusantium cumque est, ullam temporibus aut veniam vero magnam. Sunt labore faciListGroupItems perspiciatis, necessitatibus numquam tempore! </p>
                    </Col>
